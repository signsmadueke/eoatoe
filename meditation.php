...
<section id="other-devotionals">
    ...
    <?php
        if (!empty($othermeditationsDesc)) {
            foreach ($othermeditationsDesc as $otherdevotion) {
                extract($otherdevotion);
                $meditation_link = strtolower(str_replace(" ", "-", $meditation_title)); ?>

                    <a href="devotional?devotion=<?= $meditation_link; ?>" class="prev-devotional">
    ...
    <?php
        if (!empty($othermeditations)) {
            foreach ($othermeditations as $otherdevotionA) {
                extract($otherdevotionA);
                $meditation_link = strtolower(str_replace(" ", "-", $meditation_title)); ?>

                    <a href="devotional?devotion=<?= $meditation_link; ?>" class="next-devotional">
                        <div class="btn btn-chevron">
