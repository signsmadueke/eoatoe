...
(function () {
    document.getElementById("edit_newbook").addEventListener("submit", function (e) {
        e.preventDefault();
        ...
        fetch(`polling/php/edit?newbook_id=${book_id}`, {
            method : "post",
            body : form_inputs
        }).then(r => r).then(r => r.text()).then(r => {
            if (r === "true") {
                toastr.success("New Book edited successfully!","New Book Edited");
