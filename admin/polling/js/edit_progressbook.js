...
(function () {
    document.getElementById("edit_progressbook").addEventListener("submit", function (e) {
        e.preventDefault();
        ...
        fetch(`polling/php/edit?progressbook_id=${book_id}`, {
            method: "post",
            body: form_inputs
        }).then(r => r).then(r => r.text()).then(r => {
            if (r === "true") {
                toastr.success("Book in Progress edited successfully!", "Book in Progress Edited");
