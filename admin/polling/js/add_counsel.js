...
(function () {
    document.getElementById("counsel_form").addEventListener("submit", function (e) {
        e.preventDefault();
        ...
        fetch(`polling/php/add_counsel`, {
            ...
            if (d === "true") {
                toastr.success("New Counsel Added!", "Counsel Added");
                document.getElementById("counsel_form").reset();
