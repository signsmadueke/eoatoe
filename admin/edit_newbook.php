...
if (isset($_GET['newbook_id'])) {
    $bookId = $_GET['newbook_id'];

    $result = where("newbooks", "book_id", "$bookId");
    if ($result) {
        $newbook_details = $result;
    }
}
...
<?php require_once "includes/templates/topbar.php"; ?>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title-wrap bar-success">
                            <h4 class="card-title" id="basic-layout-form">Edit New Book</h4>
                        </div>
                        <p class="mb-0">Edit New Book here.</p>
                    </div>
                    <div class="card-body">
                        <div class="px-3">

                            <?php
                            if (!empty($newbook_details)) {
                                foreach ($newbook_details as $newbook_detail) {
                                    extract($newbook_detail); ?>
                                    <form class="form" method="post" action="" enctype="multipart/form-data" id="edit_newbook">
                                        <input id="bookId" type="hidden" data-id="<?= $book_id; ?>">
                                        <div class="form-body">
                                            <h4 class="form-section">
                                                <i class="icon-note"></i> Edit New Book</h4>
                                            <div class="row">
                                                <div class="col-md-6">
    ...
    <script src="polling/js/edit_newbook.js"></script>
